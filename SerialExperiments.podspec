#
#  Be sure to run `pod spec lint SerialExperiments.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description = <<-DESC
                  It is just test framework to try CocoaPods
                   DESC
  ...
  # Or just: spec.author    = "Daniil Alferov"
  # spec.authors            = { "Daniil Alferov" => "daniil.alferov@apsis.com" }
  # spec.social_media_url   = "https://twitter.com/Daniil Alferov"
